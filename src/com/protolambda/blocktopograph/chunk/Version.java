...
public enum Version {
    ...
    v0_9("v0.9.0", "Infinite worlds using LevelDB and compressed using ZLib; introduced in v0.9.0", 2, 128, 1),
    V1_0("v1.0.0", "Stacked sub-chunks, 256 world-height, 16 high sub-chunks; introduced in alpha v1.0.0", 3, 16, 16);
    ...
    // Use a HashMap with Integer keys as alternative to SparseArray
