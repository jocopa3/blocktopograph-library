...
public enum Entity implements NamedBitmapProviderHandle, NamedBitmapProvider {
    ...
    private static final HashMap<String, Entity> entityMap;
    private static final HashMap<Integer, Entity> entityByID;
    ...
    public static void loadEntityBitmaps() throws IOException {
        // Load from local jar assets
        BufferedImage sheet = ImageUtil.readImage("entity_wiki.png");
        ...
        for(Entity e : Entity.values()){
            if(e.bitmap == null && e.sheetPos >= 0){
                ...
                e.bitmap = ImageUtil.scaleImage(sheet.getSubimage(x, y, tileSize, tileSize), 32, 32);
                //Bitmap.createScaledBitmap(Bitmap.createBitmap(sheet, x, y, tileSize, tileSize, null, false), 32, 32, false);
            }
        }
    }
}
